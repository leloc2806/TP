...
export default async function SocialWhite(){

    const socialLink = await fetchSocial();
    const social = flattenAttributes(socialLink);

    return (
        <MotionSocial className="social white">
            <ul>
                <li>
                ...
                <li>
                    <a className="zalo" href={`${social.Zalo}`} target="_blank" rel="noopener" aria-label="zalo">
