import MapTabs from "@/app/components/contact/tabLocation";
...
export default async function Contact() {
    ...
    return (
        <div className="relative m-0 contact-page">
            ...
            <SectionComponent className="agency is-show block relative" translate={"translateY(-200px)"}>
                <div className="wrap-content">
            ...
            <SectionComponent className="half-wrap half-50 is-show" translate={"translateY(-200px)"}>
                <div className="wrap-content">
            ...
            <SectionComponent className="half-wrap half-50 page-contact is-show" translate={"translateY(-200px)"}>
                <div className="wrap-content">
                    <div className="left-content">
                        <div className="title-big text-ani-item color-blue">
                            <div className="text-inner-ani">
                            ...
                            <ul className="company-info">
                                ...
                                <li>
                                    <span className="address">
                                        <svg viewBox="0 0 60 60">
                                            <path fill="currentColor" d="M30,6C16.7,6,6,16.7,6,30s10.8,24,24,24s24-10.8,24-24C54,16.7,43.3,6,30,6z M47.9,28h-7c-0.5-5.2-2-10.3-4.6-14.8 C42.7,15.6,47.1,21.3,47.9,28z M25.4,34h9.3c-0.8,4.2-2.4,8.2-4.6,11.8C27.7,42.2,26.2,38.2,25.4,34z M25.1,28 c0.6-4.9,2.2-9.6,4.9-13.8c2.7,4.2,4.3,8.9,4.9,13.8H25.1z M23.6,13.2c-2.6,4.6-4.1,9.6-4.6,14.8h-7C12.9,21.3,17.3,15.6,23.6,13.2z M12.5,34h6.8c0.7,4.5,2.2,8.9,4.4,12.8C18,44.7,13.8,39.9,12.5,34z M36.4,46.8c2.2-4,3.7-8.3,4.4-12.8h6.8 C46.2,39.9,42,44.7,36.4,46.8L36.4,46.8z"></path>
                                        </svg>
                                    </span>
                                    <Link href={`/gioi-thieu`}>Giới thiệu về chúng tôi</Link>
                                </li>
                            </ul>
                        </div>
                    </div>
