    ...
    return (
        <div className="feature-new relative">
            <div className="w-[80vw] mx-auto font-normal text-xl z-10 py-[5vw] px-0">
                ...
                <div className="relative flex flex-row-reverse w-full mt-[-100px] mb-0 mx-0 p-0 cursor-pointer">
                    ...
                    <div className="txt-news w-1/2 pt-28 pr-20 pb-0 pl-0 relative text-[var(--bgactive)]">
                        ...
                        <div className="view-more relative inline-block my-8 mx-0">
                            <Link href={`/${featureItem.attributes.slug}`} className="link-load relative flex py-[5px] px-0 items-center font-bold text-sm uppercase my-0 mr-5 ml-0 text-[var(--color-black30)]">
                                Xem thêm
                            </Link>
                        </div>
                    </div>
